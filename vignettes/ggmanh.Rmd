...
An alternative to manhattan plot, binned manhattan plot, is also available in this package. 
The binned manhattan plot can be useful when the number of points is too large, as is the case for GWAS. 
